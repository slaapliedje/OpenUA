...
| I | **Rest / camp** (CODE 21), **spell memorize**, **inventory** (CODE 9) | 🟡 | **Camp menu + REST + MAGIC menu lifted (slices 1–3, 2026-06-21):** Encamp (g_walk_cmd 4) + inn open the real camp menu (`l473e`→`jt957`); **View/Magic/Rest/Save/Load/Exit navigable**. Rest (`l09ea`+`l0006_c21`+`jt915`) advances the clock and heals/memorizes. Magic menu (`l1850`) opens but its 4 spell screens (`l06d6`/`l0bc6`/`l0df2`/`l1374`) + `l1e44` + Alter (`l2d7e`) + `l038a` are stubs. See `docs/code21-camp-wall.md`. |
