...
| I | **Rest / camp** (CODE 21), **spell memorize**, **inventory** (CODE 9) | 🟡 | **Camp menu + REST lifted (slices 1–2, 2026-06-21):** the Encamp command (g_walk_cmd 4) + inn open the real camp menu (`l473e`→`jt957`); **View/Rest/Save/Load/Exit work**. Rest (`l09ea`+`l0006_c21`+the existing `jt915`) advances the clock and heals/memorizes. Still stubbed: Magic (`l1850`), `l1e44`, Alter (`l2d7e`), `l038a`. See `docs/code21-camp-wall.md`. |
