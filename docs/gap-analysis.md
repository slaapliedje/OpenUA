...
| F | **Dungeon EVENTS** (`l709e`, 39 arms) | 🟡 | **13 handlers lifted** (text `l4d26` 2/14, give-treasure `l28b0` 3/25, stairs `l5676` 5/11/34, tavern `l4f9a` 7, shop `l5586` 8, temple `l216a` 9, **conditional/stat-check `l1ad8` 15 ✅ NEW**, vault `l3a32` 24, combat-prompt `l3b0e`/`l673e` 10/21, Yes/No question `l3118` 36). **~20 still STUB.** |
