...
Leaf dependencies — **6 already lifted**: jt358, jt397, jt384, jt394, jt404,
jt201. **3 absent (B2 = lift these first):**

| leaf | alias | CODE | off | insn | note |
|------|-------|------|-----|------|------|
| jt193 | l4fbe | 7 | 0x4fbe | ~30 | frame 0 — smallest, lift first |
| jt207 | l5484 | 7 | 0x5484 | ~35 | frame 0 |
| jt1076 | l7ab4 | 5 | 0x7ab4 | ~100 | frame −86 |

Plan:
- **B2** — lift jt193 + jt207 + jt1076 (the 3 absent leaves).
- **B3** — lift the jt254 helper cluster (L541c, L4c92, L4dcc, L4e3e, L514e,
  L5194) + the L4eb2 −102 worker; JT[3] switches via `tools/jt3_extract.py`.
- **B4** — wire the jt254 entry (l4c5a) + verify the whole screen builds.
...
STATUS 2026-07-05: B1 (scope) DONE. Next: B2 (the 3 absent leaves).
