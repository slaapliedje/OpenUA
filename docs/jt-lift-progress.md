...
**1205 distinct JT entries are called.** Overall: 1163 done (1037 lifted, 52 noop, 74 alias), 15 stub, 0 stand-in, 27 missing.
...
| CODE 2 | 14 | 9 | 0 | 0 | 5 | **5** | design EDITOR — event/zone/map-step editing (Step Event, Rest in Zone, Chain, col/row cursor) — AUTHORING, not the play path |
...
| CODE 10 | 12 | 6 | 0 | 0 | 6 | **6** | PICTURE/sprite display — PIC/SPRIT/CPIC event & portrait images (jt1004 art primitive); overlaps the event-picture path (#125) |
...
Top 42 of 42 pending (stub+standin+missing), by call count:
