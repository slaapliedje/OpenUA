...
| CODE 12 | 23 | 23 | 0 | 0 | 0 | **0** | Training Hall menu + roster (jt918 / l0aae / l02dc) |
...
CODE-local helpers still PROBE-only in boot.c (9 found). These don't appear in the JT scoreboard above but gate the entries that call them.

> `l5ac0`  `l24aa`  `l7de0`  `l4350`  `l7abe`  `l4932`  `l493a`  `l341a`  `l0370`
...
Top 5 of 5 pending (stub+standin+missing), by call count:
