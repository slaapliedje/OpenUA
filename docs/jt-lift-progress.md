...
**1205 distinct JT entries are called.** Overall: 1166 done (1040 lifted, 52 noop, 74 alias), 15 stub, 0 stand-in, 24 missing.
...
| CODE 10 | 12 | 9 | 0 | 0 | 3 | **3** | PICTURE/sprite display — PIC/SPRIT/CPIC event & portrait images (jt1004 art primitive); overlaps the event-picture path (#125) |
...
Top 39 of 39 pending (stub+standin+missing), by call count:
