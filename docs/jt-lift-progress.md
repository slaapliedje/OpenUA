...
**1205 distinct JT entries are called.** Overall: 1167 done (1041 lifted, 52 noop, 74 alias), 15 stub, 0 stand-in, 23 missing.
...
| CODE 10 | 12 | 10 | 0 | 0 | 2 | **2** | PICTURE/sprite display — PIC/SPRIT/CPIC event & portrait images (jt1004 art primitive); overlaps the event-picture path (#125) |
...
Top 38 of 38 pending (stub+standin+missing), by call count:
