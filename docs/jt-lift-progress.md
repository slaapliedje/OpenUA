...
**1205 distinct JT entries are called.** Overall: 1136 done (1018 lifted, 51 noop, 67 alias), 14 stub, 0 stand-in, 55 missing.
...
| CODE 11 | 12 | 9 | 0 | 0 | 3 | **3** | design EDITOR — 3D-MAP (GEO) editing + save (Save3DMap, 'Unable to write geo') — AUTHORING, not the play path |
...
Top 50 of 69 pending (stub+standin+missing), by call count:
