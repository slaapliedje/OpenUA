...
| Window Manager      | Editor & play-UI windows         | Reimplemented in the shim — window record, list, lifecycle, geometry, b&w / colour / resource-loaded windows (`compat/windows.c`); frames & drawing await the HAL | wip |
