...
| `l2e92` `l2f82` | 0x2e92 / 0x2f82 | 87/47ln | l3540 west-edge (-7932) and north-edge (-7933) field decorations — stamp the cell-block/passage/door tiles via l2ca6(col,row,val) per the edge code | **LIFTED** (full; dep l2ca6 PROBE stub — the field-cell paint primitive) |
