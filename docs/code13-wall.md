...
| `l3540` | 0x3540 | 88ln | l3f24's outdoor-normal field-init tail: jt399-fills field map -25318+9 with terrain 22, then scans a 13(row)x5(col) window around the party — 4 cardinal l2df8_c13 edge queries (-7932/-7933/-7931/-7930) + per-cell passes l2e92/l2f82/l3016/l32ba | **LIFTED** (full; deps jt399/l2df8_c13 lifted; spawned PROBE stubs l2e92/l2f82/l3016/l32ba) |
| `l3016` `l32ba` | 0x3016 / 0x32ba | 181/191ln | jt3 inline-switch sub-dispatchers (per-cell field passes; take &row,&col) | `stub` (PROBE; spawned by l3540) |
